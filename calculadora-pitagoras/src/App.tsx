...
function App() {
  ...
  return (
    <div className="justify-center text-center p-2 mt-8">
      <div>
        <h1 className="text-6xl mb-16">Teorema de Pitágoras</h1>
      </div>
      <div className="flex flex-col xl:flex-row sm:justify-between h-max  text-center items-center xl:items-start gap-y-12">
        <FormCalc
          ...
          setValoresAbsolutos={setValoresAbsolutos}
        />
        <TriangleShape
      ...
      <div className="flex xl:absolute mt-24 align-baseline right-20 bottom-4 justify-end  flex-col xl:items-end xl:text-end">
        <p>
          Construído com React e Flask para a seleção de estágio da{" "}
          <a href="https://www.cromai.com" className="text-[#09c184]">
            Cromai
          </a>
        </p>
        <p className="">
          Feito por{" "}
          <a
            href="https://github.com/ronaldo26rodrigues"
            className="text-[#09c184]"
          >
            Ronaldo Rodrigues
          </a>
        </p>
